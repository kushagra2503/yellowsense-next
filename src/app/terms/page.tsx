  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12">
      ...
      <div className="prose max-w-3xl text-gray-700 space-y-4">
        <p>Welcome to Yellowsense Technologies. By using our services, you agree to the following terms.</p>
        ...
        <p>Yellowsense Technologies acts as a platform to connect you with service providers. While we verify professionals, we are not liable for personal disputes beyond the scope of the service agreement.</p>
      </div>
    </div>
  );
}
